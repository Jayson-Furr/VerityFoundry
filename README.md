...
[![Release](https://img.shields.io/badge/release-v0.23.0-blue)](https://github.com/Jayson-Furr/VerityFoundry/releases/tag/v0.23.0)
...
```bash
pip install "verityfoundry @ git+https://github.com/Jayson-Furr/VerityFoundry.git@v0.23.0"
...
```bash
verityfoundry check release-integrity
verityfoundry check release-integrity --expected-version 0.23.0
