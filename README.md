...
[![Release](https://img.shields.io/badge/release-v0.27.0-blue)](https://github.com/Jayson-Furr/VerityFoundry/releases/tag/v0.27.0)
...
- Golden output fixtures for Unity game, Unity shared-library, and lifecycle
  release, maintenance, decommissioning, and archival review workflows.
...
```bash
verityfoundry check release-integrity
verityfoundry check release-integrity --expected-version 0.27.0
...
- [Policy-lint trend snapshot update checklist](docs/policy-lint-trend-snapshot-update-checklist.md)
- [Render-profile snapshots](docs/render-profile-snapshots.md)
- [Render-profile snapshot retention policy](docs/render-profile-snapshot-retention-policy.md)
- [Quality thresholds](docs/quality-thresholds.md)
- [Quality-threshold warning trends](docs/quality-threshold-warning-trends.md)
- [Quality-threshold warning triage](docs/quality-threshold-warning-triage.md)
...
- [Release-review bundle manifest design](docs/release-review-bundle-manifest-design.md)
- [Release-review bundle manifest schema](docs/release-review-bundle-manifest-schema.md)
- [Release-review bundle checksums](docs/release-review-bundle-checksums.md)
- [Release-review bundle dry-run CLI design](docs/release-review-bundle-dry-run-cli-design.md)
...
- [Cross-workspace dependency fixture compatibility](docs/cross-workspace-dependency-fixture-compatibility.md)
- [Cross-workspace fixture graph review checklist](docs/cross-workspace-fixture-graph-review-checklist.md)
- [Portfolio dependency lockfile assumption checklist](docs/portfolio-dependency-lockfile-assumption-checklist.md)
- [VeritySpec workspace dependency importer design](docs/verityspec-workspace-dependency-importer-design.md)
- [VeritySpec dependency lockfile prompt workflows](docs/verityspec-dependency-lockfile-prompt-workflows.md)
