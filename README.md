...
[![Release](https://img.shields.io/badge/release-v0.24.0-blue)](https://github.com/Jayson-Furr/VerityFoundry/releases/tag/v0.24.0)
...
```bash
verityfoundry check release-integrity
verityfoundry check release-integrity --expected-version 0.24.0
