...
[![Release](https://img.shields.io/badge/release-v0.18.0-blue)](https://github.com/Jayson-Furr/VerityFoundry/releases/tag/v0.18.0)
...
```bash
verityfoundry check release-integrity
verityfoundry check release-integrity --expected-version 0.18.0
